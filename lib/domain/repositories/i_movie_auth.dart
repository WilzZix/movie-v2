...
abstract class MovieDBAuth {
  Future<ResultEntity<RequestTokenModel>> getRequestToken({required String clientId});

  Future<ResultEntity<SessionIdModel>> getSessionId({required String requestToken, required String clientId});
